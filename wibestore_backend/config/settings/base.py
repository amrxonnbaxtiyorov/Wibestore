...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@wibestore.net")

# Frontend base URL (email linklar, reset/verify — Railway/custom domen uchun)
FRONTEND_URL = (env("FRONTEND_URL", default="https://wibestore.net") or "https://wibestore.net").rstrip("/")
