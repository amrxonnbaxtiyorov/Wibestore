...
import { Search, Menu, X, Sun, Moon, User, LogOut, Settings, ShoppingBag, Crown, ChevronDown, TrendingUp, BarChart3, Zap, GitCompare } from 'lucide-react';
...
const Navbar = () => {
    ...
    const navLinks = [
        ...
        { to: '/compare', label: t('nav.compare') || 'Solishtirish', icon: GitCompare },
