...
const PremiumPage = () => {
    const { t } = useLanguage();
    const { user: _user } = useAuth(); // reserved for subscription/display
    ...
    const handleSubscribe = (planSlug) => {
        setError('');
        // Open Telegram bot with the plan as start parameter
        const telegramUrl = `https://t.me/${TELEGRAM_BOT_USERNAME}?start=premium_${planSlug}`;
                            ...
                            <div className="text-center" style={{ marginBottom: '24px' }}>
                                {plan.priceUZS > 0 ? (
                                    <>
                                        ...
                                        <span style={{ color: 'var(--color-text-muted)', fontSize: 'var(--font-size-sm)', marginLeft: '4px' }}>UZS / oy</span>
                                    </>
                                ) : (
                                    <span style={{
                                        fontSize: 'var(--font-size-3xl)',
