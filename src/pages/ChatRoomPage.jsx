                                        ...
                                        <div key={msg.id}>
                                            {showDateSep && (
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '12px 0', padding: '0 4px' }}>
                                                    ...
                                                    <span style={{ fontSize: '12px', fontWeight: 600, color: 'var(--color-text-secondary)', flexShrink: 0, padding: '4px 12px', backgroundColor: 'var(--color-bg-secondary)', borderRadius: '999px', border: '1px solid var(--color-border-muted)' }}>{dateSepLabel}</span>
                                                    <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--color-border-muted)' }} />
                                                </div>
                                            )}
                                            <div style={{ textAlign: 'center', padding: '8px 0' }}>
                                                <span style={{ fontSize: '13px', fontWeight: 600, color: 'var(--color-text-secondary)', backgroundColor: 'var(--color-bg-secondary)', padding: '6px 14px', borderRadius: 'var(--radius-full)', border: '1px solid var(--color-border-muted)' }}>
                                                    🛡️ {msg.content}
                                                </span>
                                            </div>
                                        </div>
